...
// copied and adjusted from the current android sourcecode at http://android.git.kernel.org/?p=platform/frameworks/base.git;a=commit;h=HEAD
// revision 069e810c6a5e
...
public class IntentFilter {
	...
	public String toString() {
		return "IntentFilter [mPriority=" + mPriority + ", mActions="
				+ mActions + ", mCategories=" + mCategories + ", mDataSchemes="
				+ mDataSchemes + ", mDataAuthorities=" + mDataAuthorities
				+ ", mDataPaths=" + mDataPaths + ", mDataTypes=" + mDataTypes
